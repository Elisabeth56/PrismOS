...
const MOCK_PROJECTS: Project[] = [
  {
    id: 'proj-1',
    name: 'Fintech App',
    description: 'Mobile-first fintech product with auth, transactions, and KYC flow.',
    run_count: 14,
    memory_entry_count: 38,
    last_run_at: '2h ago',
    verdict_breakdown: { shippable: 12, needs_revision: 2 },
  },
  {
    id: 'proj-2',
    name: 'E-commerce Platform',
    description: 'Next.js storefront with Stripe, inventory management, and order tracking.',
    run_count: 7,
    memory_entry_count: 19,
    last_run_at: '1d ago',
    verdict_breakdown: { shippable: 6, needs_revision: 1 },
  },
  {
    id: 'proj-3',
    name: 'Internal Dev Tool',
    description: 'CLI + dashboard for deployment pipeline monitoring.',
    run_count: 3,
    memory_entry_count: 8,
    last_run_at: '4d ago',
    verdict_breakdown: { shippable: 3, needs_revision: 0 },
  },
]
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <motion.button
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: MOCK_PROJECTS.length * 0.07 }}
            onClick={() => setShowCreate(true)}
